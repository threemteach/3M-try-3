    ...
    <>
      <section className="relative min-h-[90vh] lg:min-h-screen overflow-hidden bg-[#302451]">
        ...
        <Image
          ...
          priority
        />
        <div className="relative z-10 flex min-h-[90vh] items-center pl-4 pr-4 md:items-start md:pt-28 lg:items-center lg:pt-0">
          <div style={{ marginLeft: 150 }} className="max-w-[900px]">
