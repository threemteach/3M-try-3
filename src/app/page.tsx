    ...
    <>
      <section className="relative min-h-[90vh] lg:min-h-screen overflow-hidden bg-[#302451]">
        ...
        <Image
          ...
          width={1050}
          height={600}
          className="absolute right-0 z-[1] h-auto w-[585px] bottom-0 -translate-x-6 transition-all duration-500 ease-in-out md:w-[494px] md:-translate-x-4 lg:w-[1365px] lg:-translate-x-[120px]"
          priority
        />
        <Navbar />
      </section>
