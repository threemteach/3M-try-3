    ...
    <>
      <section className="relative min-h-[90vh] lg:min-h-screen overflow-hidden bg-[#302451]">
        ...
        <Image
          ...
          width={1050}
          height={600}
          className="absolute right-0 z-[1] h-auto w-[450px] bottom-[60px] -translate-x-6 transition-all duration-500 ease-in-out md:bottom-0 md:w-[494px] md:-translate-x-4 lg:mt-[270px] lg:w-[1050px] lg:-translate-x-[120px] lg:bottom-auto"
          priority
        />
        <Navbar />
      </section>
