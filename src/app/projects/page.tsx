  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#f3f0f3]">
      <header className="relative overflow-hidden bg-[#302451] px-4 pb-24 pt-6 text-white sm:pb-32 sm:pt-10 lg:pb-40">
        ...
        <div className="relative z-10 mx-auto max-w-[900px] pb-2 pt-8 text-center sm:pt-20">
                ...
                <div className="absolute inset-x-0 bottom-0 flex min-h-[40%] flex-col justify-end px-5 pb-5 pt-20 text-left sm:px-6 sm:pb-6">
                  ...
                  <div className="relative">
                    <div className="flex items-end gap-3">
                      ...
                      <span className="mb-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-[4px] border border-[#302451]/60 text-base text-[#302451] transition-colors group-hover:bg-[#302451] group-hover:text-white">
                        {"↗"}
                      </span>
                    </div>
